...
export const changeName = (user) => ({ type: CHANGE, user });
// const user = "아오";
...
const userEdit = (state = initState, action) => {
  switch (action.type) {
    case CHANGE:
      return {
        // 불변성 유지
...
// // const USER = "user";
// // // const user = "아오";
// // export const changeName = (user) => ({ type: USER, user });
// // // export const  changeName  (edit) => ({ type: Text, edit });
