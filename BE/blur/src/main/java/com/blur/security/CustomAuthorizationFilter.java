...
import static com.blur.security.JwtConstants.TOKEN_HEADER_PREFIX;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (servletPath.equals("/api/login") || servletPath.equals("/api/refresh")) {
			...
			try {
				...
				List<SimpleGrantedAuthority> authorities = strAuthorities.stream().map(SimpleGrantedAuthority::new)
						.toList();
